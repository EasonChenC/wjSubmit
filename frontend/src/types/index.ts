...
export interface Questionnaire { activity_id:string; url:string; total_questions:number; question_types:Record<string,number>; questions:Question[]; scale_questions:number; reverse_items:string[] }
